        ...
        const heroes = [
            {
                ...
                description: "2020-21 সেশন এর বড় ভাইদের বিদায় এবং 2023-24 সেশন এর ছোট ভাইদের নবীণ বরণ উপলক্ষে আনন্দ ভ্রমণ 18-04-2024 তারিখে- “ডাক বাংলো, আনন্দ ধারা রিসোর্ট, মহারাজা দিঘী, তেঁতুলিয়া, পঞ্চগড়।”",
                image: Img2,
                reverse: true,
            },
            {
                id: 4,
                title: "আমরা ঐক্য ছাত্রাবাস পরিবার",
                description: "2021-22 সেশন এর বড় ভাইদের বিদায় এবং 2024-25 সেশন এর ছোট ভাইদের নবীণ বরণ উপলক্ষে আনন্দ ভ্রমণ 11-04-2025 তারিখে- “সাফিনা পার্ক, রাজশাহী ইউনিভার্সিটি, আই-বাদ, টি-বাদ, পদ্মা গার্ডেন, রাজশাহী।”",
                image: Img4,
                reverse: false,
            },
            {
                id: 3,
                title: "আমরা ঐক্য ছাত্রাবাস পরিবার",
                description: "2022-23 সেশন এর (আমাদের) বিদায় উপলক্ষে এবং 2025-26 সেশন এর ছোট ভাইদের নবীণ বরণ আনন্দ ভ্রমণ তারিখে- 08-05-2026 - 09-05-2026 “জাফলং, শ্রীমঙ্গল, সিলেট।”",
                image: Img3,
                reverse: true,
            },
            {
